...
class GoogleSearch(object):
    ...
    SEARCH_URL_1 = "http://www.google.com/search?hl=en&as_q=%(query)s&num=%(num)d&ft=i&as_qdr=all&as_occt=any"
    NEXT_PAGE_1 = "http://www.google.com/search?hl=en&as_q=%(query)s&num=%(num)d&start=%(start)d&ft=i&as_qdr=all&as_occt=any"
#http://www.google.com/search?hl=en&as_q=cat&as_epq=&as_oq=&as_eq=&num=50&lr=&as_filetype=&ft=i&as_sitesearch=&as_qdr=all&as_rights=&as_occt=any&cr=&as_nlo=&as_nhi=&safe=images
